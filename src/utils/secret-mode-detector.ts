 ...
 * Desktop: Type "statefx" then press Enter twice
 */
...
class SecretModeDetector {
    ...
    private readonly TARGET_SEQUENCE = 'statefx';
    ...
    private handleKeyDown(e: KeyboardEvent) {
        ...
        if (e.key === 'Enter') {
            ...
            // Keep only the last 7 characters (length of "statefx")
            ...
            if (currentSequence === this.TARGET_SEQUENCE) {
                console.log('✅ Sequence "statefx" typed! Press Enter twice...');
            }
        }
    }
